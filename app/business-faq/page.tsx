...
export const metadata: Metadata = {
  title: "Business FAQ | OfferBeez",
  description:
    "Frequently Asked Questions for OfferBeez business partners. Find answers about partnership, offer management, payments, and more.",
  robots: "index, follow",
  alternates: { canonical: "/business-faq" },
  openGraph: {
    title: "Business FAQ | OfferBeez",
    description:
      "Frequently Asked Questions for OfferBeez business partners. Find answers about partnership, offer management, payments, and more.",
    url: "https://offerbeez.com/business-faq",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1ZDNhCbWW38Y12cPdpTrNqdXDpM1M7RqVc8MLoNXqhzk"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Business FAQ (status ${res.status})`)
...
export default async function BusinessFAQ() {
  let content = ""
  ...
  try {
    ...
    content = "<p>We couldn't display the Business FAQ content at this moment. Please try reloading the page.</p>"
    toc = []
  }
    ...
    <main className="bg-white">
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Business FAQ</h1>
            <p className="text-sm text-gray-500">
              Frequently Asked Questions for OfferBeez business partners. Find answers about partnership, offers, and payments.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">Business FAQ</p>
              )}
            </div>
          </aside>
          ...
          <article className="lg:col-span-9">
            <div 
              className="faq-content prose prose-lg max-w-none" 
