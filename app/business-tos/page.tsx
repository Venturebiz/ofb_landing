...
export const metadata: Metadata = {
  title: "Business Terms of Service | OfferBeez",
  description:
    "OfferBeez Business Terms of Service. These terms govern your use of OfferBeez services as a business partner. Please read them carefully.",
  robots: "index, follow",
  alternates: { canonical: "/business-tos" },
  openGraph: {
    title: "Business Terms of Service | OfferBeez",
    description:
      "OfferBeez Business Terms of Service. These terms govern your use of OfferBeez services as a business partner. Please read them carefully.",
    url: "https://offerbeez.com/business-tos",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1NjBIP1keu2qX0FwYbs0UE6shNbmalbeIX3c2KmNLjqs"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Business Terms of Service (status ${res.status})`)
...
export default async function BusinessTOS() {
  let content = ""
  ...
  try {
    ...
    content = "<p>We couldn't display the Business Terms of Service content at this moment. Please try reloading the page.</p>"
    toc = []
  }
    ...
    <main className="bg-white">
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Business Terms of Service</h1>
            <p className="text-sm text-gray-500">
              These terms govern your use of OfferBeez services as a business partner. Please read them carefully.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">Business Terms</p>
              )}
            </div>
          </aside>
          ...
          <article className="lg:col-span-9">
            <div 
              className="tos-content prose prose-lg max-w-none" 
