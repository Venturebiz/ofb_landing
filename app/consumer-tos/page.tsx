...
export const metadata: Metadata = {
  title: "Consumer Terms of Service | OfferBeez",
  description:
    "OfferBeez Consumer Terms of Service. These terms govern your use of OfferBeez services as a consumer. Please read them carefully.",
  robots: "index, follow",
  alternates: { canonical: "/consumer-tos" },
  openGraph: {
    title: "Consumer Terms of Service | OfferBeez",
    description:
      "OfferBeez Consumer Terms of Service. These terms govern your use of OfferBeez services as a consumer. Please read them carefully.",
    url: "https://offerbeez.com/consumer-tos",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1D565jb_K6-7o3QwJQqCr2oWqEzIGUrOULaSCG4kSD58"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Consumer Terms of Service (status ${res.status})`)
...
export default async function ConsumerTOSPage() {
  let content = ""
  ...
  try {
    ...
    content = "<p>We couldn't display the Consumer Terms of Service content at this moment. Please try reloading the page.</p>"
    toc = []
  }
    ...
    <main className="bg-white">
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Consumer Terms of Service</h1>
            <p className="text-sm text-gray-500">
              These terms govern your use of OfferBeez services as a consumer. Please read them carefully.
            </p>
          </div>
          ...
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">Consumer Terms</p>
              )}
            </div>
          </aside>
