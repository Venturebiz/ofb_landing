...
export const metadata: Metadata = {
  title: "Cookie Policy | OfferBeez",
  description:
    "OfferBeez Cookie Policy. This policy explains how we use cookies and similar technologies on our website.",
  robots: "index, follow",
  ...
  openGraph: {
    ...
    description:
      "OfferBeez Cookie Policy. This policy explains how we use cookies and similar technologies on our website.",
    url: "https://offerbeez.com/cookiepolicy",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1fdUmNsbxfa7nMRhdquLPvMGDQEeyUNsCRrFMCI20ER4"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Cookie Policy (status ${res.status})`)
...
export default async function CookiePolicy() {
  ...
  try {
    ...
    content = "<p>We couldn't display the Cookie Policy content at this moment. Please try reloading the page.</p>"
    toc = []
  }
    ...
    <main className="bg-white">
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Cookie Policy</h1>
          ...
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">Cookie Policy</p>
              )}
            </div>
          </aside>
