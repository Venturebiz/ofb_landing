...
export const metadata: Metadata = {
  title: "Privacy Policy | OfferBeez",
  description:
    "OfferBeez Privacy Policy rendered directly on-site. This page mirrors the Google Doc to ensure accuracy while providing a structured, readable layout.",
  robots: "index, follow",
  ...
  openGraph: {
    ...
    description:
      "OfferBeez Privacy Policy rendered directly on-site. This page mirrors the Google Doc to ensure accuracy while providing a structured, readable layout.",
    url: "https://offerbeez.com/privacy-policy",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1xi_wXx8CFx2lz993cT4Ck1IEZGLqTNi4PddNP7UBcr8"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Privacy Policy (status ${res.status})`)
...
export default async function PrivacyPolicyPage() {
  ...
  try {
    ...
    content = "<p>We couldn't display the Privacy Policy content at this moment. Please try reloading the page.</p>"
    toc = []
  }
