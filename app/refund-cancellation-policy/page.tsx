...
export const metadata: Metadata = {
  title: "Refund & Cancellation Policy | OfferBeez",
  description:
    "OfferBeez Refund & Cancellation Policy. These terms govern refunds and cancellations for OfferBeez services. Please read them carefully.",
  robots: "index, follow",
  ...
  openGraph: {
    ...
    description:
      "OfferBeez Refund & Cancellation Policy. These terms govern refunds and cancellations for OfferBeez services. Please read them carefully.",
    url: "https://offerbeez.com/refund-cancellation-policy",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1KOQ2M5hI7ShGlGFAQb0-0iAKhDQE84zvb4KNolFFmZo"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load Refund & Cancellation Policy (status ${res.status})`)
...
export default async function RefundCancellationPolicy() {
  ...
  try {
    ...
    content = "<p>We couldn't display the Refund & Cancellation Policy content at this moment. Please try reloading the page.</p>"
    toc = []
  }
        ...
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-gray-500">
              These terms govern refunds and cancellations for OfferBeez services. Please read them carefully.
            </p>
          </div>
          ...
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">Refund & Cancellation Policy</p>
              )}
            </div>
          </aside>
