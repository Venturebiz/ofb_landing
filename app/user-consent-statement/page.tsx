...
export const metadata: Metadata = {
  title: "User Consent Statement | OfferBeez",
  description:
    "OfferBeez User Consent Statement. Understand how we handle your data and your rights regarding consent and privacy.",
  robots: "index, follow",
  alternates: { canonical: "/user-consent-statement" },
  openGraph: {
    title: "User Consent Statement | OfferBeez",
    description:
      "OfferBeez User Consent Statement. Understand how we handle your data and your rights regarding consent and privacy.",
    url: "https://offerbeez.com/user-consent-statement",
    siteName: "OfferBeez",
    type: "article",
  },
  twitter: {
...
const DOC_ID = "1SRqfK8dCqY2yDX868HeWDV3mraTkfNKuqcnQBLdTrHI"
...
async function getDocHtml(): Promise<{ html: string; toc: { level: number; id: string; title: string }[] }> {
  ...
  if (!res.ok) throw new Error(`Failed to load User Consent Statement content (status ${res.status})`)
...
export default async function UserConsentStatement() {
  let content = ""
  ...
  try {
    ...
    content = "<p>We couldn't display the User Consent Statement content at this moment. Please try reloading the page.</p>"
    toc = []
  }
    ...
    <main className="bg-white">
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">User Consent Statement</h1>
            <p className="text-sm text-gray-500">
              Understand how we handle your data and your rights regarding consent and privacy.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <aside className="lg:col-span-3">
            <div className="sticky top-6 rounded-xl border border-gray-200 p-4 bg-white/70 backdrop-blur">
              ...
              {toc.length > 0 ? (
                ...
                <p className="text-xs text-gray-500">User Consent Statement</p>
              )}
            </div>
          </aside>
          ...
          <article className="lg:col-span-9">
            <div 
              className="user-consent-content prose prose-lg max-w-none" 
              dangerouslySetInnerHTML={{ __html: content }} 
            />
            <hr className="my-10 border-gray-200" />
            <div className="text-xs text-gray-500">
              If you have questions about our consent practices, contact us at{" "}
